    ...
    <!-- START NAV -->
        ...
        <div class="container">
                <div class="column is-9">
                    ...
                    $sqlFullEvent = $conn ->prepare("SELECT COUNT(IDEvent) AS totalEvent FROM event;");
                    $sqlFullEvent ->execute();
                    $resultFullEvent = $sqlFullEvent ->get_result();
                    $rowDrei = $resultFullEvent->fetch_assoc();
                    $sqlFullEvent ->close();
                    ...
                    <section class="info-tiles">
                        <div class="tile is-ancestor has-text-centered">
                            ...
                            <div class="tile is-parent">
                                <article class="tile is-child box">
                                    <p class="title"> <?php  echo "" . $rowDrei['totalEvent'] . "" ;  ?> </p>
